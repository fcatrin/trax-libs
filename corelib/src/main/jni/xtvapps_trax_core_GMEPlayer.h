...
#include <jni.h>
/* Header for class xtvapps_trax_core_GMEPlayer */

#ifndef _Included_xtvapps_trax_core_GMEPlayer
#define _Included_xtvapps_trax_core_GMEPlayer
#ifdef __cplusplus
extern "C" {
#endif
#undef xtvapps_trax_core_GMEPlayer_TIME_RWND_FWD
#define xtvapps_trax_core_GMEPlayer_TIME_RWND_FWD 5000L
#undef xtvapps_trax_core_GMEPlayer_MAX_CHANNELS
#define xtvapps_trax_core_GMEPlayer_MAX_CHANNELS 24L
/*
 * Class:     xtvapps_trax_core_GMEPlayer
 * Method:    gmeOpen
