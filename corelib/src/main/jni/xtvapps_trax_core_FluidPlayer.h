...
#include <jni.h>
/* Header for class xtvapps_trax_core_FluidPlayer */

#ifndef _Included_xtvapps_trax_core_FluidPlayer
#define _Included_xtvapps_trax_core_FluidPlayer
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     xtvapps_trax_core_FluidPlayer
 * Method:    fluidInit
 * Signature: (I)Z
 */
